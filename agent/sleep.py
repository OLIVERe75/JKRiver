...
async def cross_validate_contradictions_async(contradictions: list[dict],
                                               observations: list[dict],
                                               current_profile: list[dict],
                                               config: dict,
                                               trajectory: dict | None = None) -> list[dict]:
...
async def _sweep_uncovered_observations_async(observations: list[dict], config: dict,
                                               trajectory: dict | None = None):
    llm_config = config.get("llm", {})
    language = config.get("language", "zh")
    L = get_labels("context.labels", language)
