...
完了です。Web ダッシュボード `http://localhost:2345`、API `http://localhost:8400/docs`。

> **チャット履歴のインポート：** ChatGPT / Claude / Gemini のエクスポートファイルを `docker/data/ChatGPT/`、`docker/data/Claude/`、`docker/data/Gemini/` に配置して再起動してください。
>
> Telegram/Discord Bot を使う場合は、`.env` に `TELEGRAM_BOT_TOKEN` または `DISCORD_BOT_TOKEN` を設定して再起動してください。
