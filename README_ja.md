...
Python 3.10+ · PostgreSQL 16+ · [Ollama](https://ollama.ai)（オプション、クラウドのみも可）
...
# settings.yaml を編集 — database.user、LLM、Bot トークンを設定
# 完全な設定ガイド：https://wangjiake.github.io/riverse-docs/ja/getting-started/configuration/
